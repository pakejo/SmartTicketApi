...
namespace SmartContracts.Contracts.SmarTicket
{
    public partial class SmarTicketService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, SmarTicketDeployment smarTicketDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<SmarTicketDeployment>().SendRequestAndWaitForReceiptAsync(smarTicketDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, SmarTicketDeployment smarTicketDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<SmarTicketDeployment>().SendRequestAsync(smarTicketDeployment);
        }

        public static async Task<SmarTicketService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, SmarTicketDeployment smarTicketDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, smarTicketDeployment, cancellationTokenSource);
            return new SmarTicketService(web3, receipt.ContractAddress);
        }
        ...
        public SmarTicketService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
            ContractHandler = web3.Eth.GetContractHandler(contractAddress);
        }

        public Task<BigInteger> MINT_PRICEQueryAsync(MINT_PRICEFunction mINT_PRICEFunction, BlockParameter blockParameter = null)
        {
            return ContractHandler.QueryAsync<MINT_PRICEFunction, BigInteger>(mINT_PRICEFunction, blockParameter);
        }

        
        public Task<BigInteger> MINT_PRICEQueryAsync(BlockParameter blockParameter = null)
        {
            return ContractHandler.QueryAsync<MINT_PRICEFunction, BigInteger>(null, blockParameter);
        }
        ...
        public Task<string> SafeMintRequestAsync()
        {
             return ContractHandler.SendRequestAsync<SafeMintFunction>();
        }
        ...
        public Task<TransactionReceipt> SafeMintRequestAndWaitForReceiptAsync(CancellationTokenSource cancellationToken = null)
        {
             return ContractHandler.SendRequestAndWaitForReceiptAsync<SafeMintFunction>(null, cancellationToken);
        }
